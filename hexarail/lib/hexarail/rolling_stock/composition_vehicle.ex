defmodule HexaRail.RollingStock.CompositionVehicle do
  use Ecto.Schema
  import Ecto.Changeset

  schema "composition_vehicles" do
    belongs_to :composition, HexaRail.RollingStock.Composition
    belongs_to :vehicle, HexaRail.RollingStock.Vehicle, type: :string
