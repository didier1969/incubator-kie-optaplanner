...
*   **Status:** domain ontology and design documents are present under `docs/plans/hexafactory/`, and the first production namespace plus foundation persistence layer now exist under `hexarail/lib/hexafactory/`
