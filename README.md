...
*   **Status:** domain ontology and design documents are present under `docs/plans/hexafactory/`, and the first production namespace plus foundation and planning persistence layers now exist under `hexarail/lib/hexafactory/`
