defmodule HexaPlanner.NightRosteringTest do
  ...
  test "Phase 15: trains sharing block_id generate a static night parking EOS" do
    ...
    SolverNif.load_trips(resource, trips)
    ...
    SolverNif.load_trips(resource, dummy_trip)
    ...
    SolverNif.load_stop_times(resource, dummy_stop_times)
    
    # Finalize again to include dummy
    SolverNif.finalize_temporal_graph(resource)
    
    conflicts = SolverNif.get_conflict_summary(resource)
