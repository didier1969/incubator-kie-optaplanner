defmodule HexaPlanner.GTFS.TripTest do
  ...
  test "validates required trip fields" do
    ...
    assert %{trip_id: ["can't be blank"], route_id: ["can't be blank"], service_id: ["can't be blank"]} = errors_on(changeset)
  end
end
...
defmodule HexaPlanner.GTFS.StopTimeTest do
  ...
  test "validates required stop time fields" do
    ...
    assert %{trip_id: ["can't be blank"], stop_id: ["can't be blank"], arrival_time: ["can't be blank"], stop_sequence: ["can't be blank"]} = errors_on(changeset)
  end
end
...
defmodule HexaPlanner.GTFS.TransferTest do
  ...
  test "validates required transfer fields" do
    ...
    assert %{from_stop_id: ["can't be blank"], to_stop_id: ["can't be blank"], transfer_type: ["can't be blank"]} = errors_on(changeset)
  end
end
